          ...
          <div className="row align-items-xl-center mt-n7">
            <div className="col-lg-6 mt-7 wow fadeIn">
              <div className="ps-lg-1-9 ps-xl-7">
                ...
                >
                  Grab that{' '}
                  <strong>C3-Mini™ Spotify Remote Control Box</strong> and play
                  the songs from your Spotify Playlist, all wall-mounted so that
                  you always find it at the same spot.
                </p>
              </div>
            </div>
            ...
            <div className="col-12 mt-7 border-start border-5 border-warning ps-4">
              ...
              electromagnetic compatibility regulations. Note: C3-Mini™ is a
              trademark of ChipGlobe GmbH.
            </div>
          </div>
        </div>
      </div>
