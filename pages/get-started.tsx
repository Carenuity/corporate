      ...
      <section className="overflow-hidden py-3">
        <div className="container position-relative z-index-3">
          <div>
            ...
            <p>
              The <strong>Carenuity SQ-Panel</strong> is a smart indoor climate
              monitor designed to measure air quality and comfort. It connects
              via the Carenuity App and integrates into your smart home through
              the Matter standard.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                <strong>remote monitoring</strong> through the Carenuity App.
              </li>
              <li>
                Supports <strong>Matter over Thread</strong> for cross-platform
                smart home integration (Apple, Google, Amazon, SmartThings, Home
                Assistant).
              </li>
            </ul>
            ...
            <ul>
              <li>
                Ensure a Matter-enabled Border Router (e.g., HomePod mini,
                Google Nest Hub, or Carenuity router) is active on your Wi-Fi.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Follow in-app instructions until status shows <em>Connected</em>
                .
              </li>
            </ul>
            ...
            <ul>
              <li>
                During setup, SQ-Panel is automatically added to your Matter
                ecosystem.
              </li>
              <li>
                Supported ecosystems: Apple Home, Google Home, Amazon Alexa,
                Samsung SmartThings, Home Assistant.
              </li>
              <li>
            ...
            <ol className="mb-6">
              ...
              <li>
                <strong>Firmware</strong>: Check <em>Menu → Firmware Update</em>
                .
              </li>
            </ol>
