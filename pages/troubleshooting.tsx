      ...
      <section className="overflow-hidden py-3">
        <div className="container position-relative z-index-3">
          <div className="row">
            ...
            <p>
              This section helps you quickly identify and resolve common issues
              with your SQ-Panel and Carenuity App. Each flow guides you step by
              step. If the issue persists, you&apos;ll find an escalation
              checklist and support options at the end.
            </p>
          </div>
          <div>
            ...
            <p>
              <strong>If unresolved:</strong> Collect serial number (back of
              device), app version, and firmware version, then open a ticket.
            </p>
            ...
            <p>
              <strong>If unresolved:</strong> Provide screenshots, app version,
              and date/time of failed sync when contacting support.
            </p>
            ...
            <ol>
              <li>
                ...
                <ul>
                  <li>
                    Device may be near heat sources, direct sunlight, or draft.
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Ensure no nearby CO₂ sources (candles, stoves, many people).
                  </li>
                </ul>
              </li>
              <li>
            ...
            <p>
              <strong>If unresolved:</strong> Provide 2–3 sample values, room
              type, and environment conditions in your support ticket.
            </p>

            <h4>4. Alarms Not Triggering</h4>
            <ol>
              <li>
                Check if alerts are enabled in the app (Settings →
                Notifications).
              </li>
              <li>
                ...
                <ul>
                  <li>
                    Example: CO₂ alarm triggers &gt;1000 ppm (customizable).
                  </li>
                </ul>
              </li>
              <li>Is “Do Not Disturb” mode active on your phone?</li>
              <li>
                Restart the app and re-test alarm with a manual threshold.
              </li>
            </ol>
            <p>
              <strong>If unresolved:</strong> Provide screenshots of alarm
              settings and app notification settings.
            </p>
            ...
            <p>
              <strong>If unresolved:</strong> Send device serial number,
              firmware version (Settings → Device Info), and app version to
              support.
            </p>
            ...
            <ul>
              ...
              <li>
                Description of issue, steps already tried, and screenshots if
                possible
              </li>
            </ul>
