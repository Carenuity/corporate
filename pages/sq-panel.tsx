        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'Product',
              name: 'SQ-Panel',
              image: `${targetDomain}/img/content/sq-panel-plus/sq-panel.png`,
              description:
              ...
              <tbody>
                ...
                <tr style={{ background: '#eeeeee' }}>
                  ...
                  >
                    ...
                    {state === 'de' && (
                      <>
                        {' '}
                        (direkter Anschluss mit 220-240V AC Transformator) max
                        5W 120-240AC 50/60Hz
                      </>
                    )}
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  >
                    ...
                    {state === 'de' && (
                      <>
                        90° horizontale ebene Strahlbreite (HPBW) -+45
                        <sup>o</sup> Azimuth & +40<sup>o</sup> Elevation FoV
                      </>
                    )}
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  >
                    ...
                    {state === 'de' && (
                      <>
                        Antennas-in-Package (AIP)-Design für kompakte
                        Integration
                      </>
                    )}
                  </td>
                ...
                <tr style={{ background: '#eeeeee' }}>
                  ...
                  >
                    {state === 'en' && (
                      <>
                        {' '}
                        Monitors the ambient temperature, enabling climate
                        control systems and user comfort adjustments
                      </>
                    )}
                    {state === 'de' && (
                      <>
                ...
                <tr>
                  ...
                  >
                    ...
                    {state === 'de' && (
                      <>
                        Verfolgt die Luftfeuchtigkeit, um die Luft zu
                        unterstützen Qualitätsüberwachung und HVAC-Optimierung
                      </>
                    )}
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  >
                    {state === 'en' && (
                      <>
                        {' '}
                        Monitors carbon dioxide levels to ensure a healthy
                        indoor environment
                      </>
                    )}
                    {state === 'de' && (
                ...
                <tr style={{ background: '#eeeeee' }}>
                  ...
                  >
                    {state === 'en' && (
                      <>
                        Monitors overall air quality, combining data from
                        multiple sensors{' '}
                      </>
                    )}
                    {state === 'de' && (
                ...
                >
                  <div className="row">
                    ...
                    <div className="col-lg-9 ">
                      ...
                      <p>
                        The red BSFZ Seal, awarded by the Federal Republic of
                        Germany, certifies that Carenuity conducts its own
                        research and development. The SQ-Panel is officially
                        recognized as a result of innovative R&D.
                      </p>
                      <p>
                        The BSFZ Seal (issued by the German Certification Office
                        for Research Grants) is an official quality mark of the
                        Federal Republic of Germany confirming that a product or
                        project is based on research and development. It
                        strengthens trust among customers, partners, and
                        investors by signaling official recognition of
              ...
              <>
                ...
                >
                  <div className="row">
                    ...
                    <div className="col-lg-9 ">
                      <h5>
                        Ausgezeichnet mit dem BSFZ-Siegel 2025 für Forschung &
                        Entwicklung
                      </h5>
                      <p>
                        Das rote BSFZ-Siegel, vergeben von der Bundesrepublik
                        Deutschland, bestätigt, dass Carenuity eigene Forschung
                        und Entwicklung durchführt. Das SQ-Panel ist offiziell
                        als Ergebnis innovativer F&E anerkannt.
                      </p>

                      <p>
                        Das BSFZ-Siegel (ausgestellt von der
                        Bescheinigungsstelle Forschungszulage) ist ein
                        offizielles Qualitätsmerkmal der Bundesrepublik
                        Deutschland und bestätigt, dass ein Produkt oder Projekt
                        auf Forschung und Entwicklung basiert. Es stärkt das
                        Vertrauen von Kunden, Partnern und Investoren, da es
                        eine staatliche Anerkennung von Innovation und
                        Glaubwürdigkeit signalisiert.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <p className="col-md-6 mb-4">
                  {!effectiveIsMobile && (
                    ...
                    >
                      <span className="small">
                        {' '}
                        Subscribe to SQ-Panel Newsletter
                      </span>
                    </Link>
                  )}
                ...
                <p className="col-md-6 mb-4">
                  {!effectiveIsMobile && (
                    ...
                    >
                      <span className="small">
                        {' '}
                        SQ-Panel-Newsletter abonnieren
                      </span>
                    </Link>
                  )}
