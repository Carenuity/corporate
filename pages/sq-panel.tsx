       ...
       < br />
        ...
        <div><br /><br /></div>
          ...
          height:'620px',
            ...
            <p>Your motorhome is parked in the front garden and you want to make sure it's comfortable 
                inside before you set off on a journey. 

            <br />The SQ-Panel shows you the indoor air parameters so that you can take measures in advance.
          ...
          height:'620px',
            ...
            <div style={{padding: '10px', }}>
            <h5>Garage:</h5>
            <p>Even in a remote garden shed or garage, you can use the SQ-Panel to monitor the presence of people
                (CO2) or vehicles (VOC). 
           ...
           <div className="col-lg-4 mt-n1-9 mb-2">
            ...
            height:'620px',
              ...
              <div style={{padding: '10px', }}>
              <h5>Garden shed:</h5>
              <p>If you store tools or plant equipment there, it is important to know if the humidity is too high to prevent
                  mold growth.
              </p>
              </div>
           ...
           <div className="col-lg-4 mt-n1-9 mb-2">
            ...
            height:'620px',
              ...
              <p>The SQ-Panel monitors indoor air parameters such as temperature, humidity, CO2 and VOC.
                  If the room is too warm or too stuffy, you can take timely action to improve the comfort of your guests. 
           ...
           <div className="col-lg-4 mt-n1-9 mb-2">
            ...
            height:'620px',
              ...
              <p>When your guests leave the room, the SQ-Panel detects their absence. Users can then switch 
                  off the lights or turn down the heating to save energy. When they return, the device alerts them and helps to ensure comfort.
          ...
          <div className="col-lg-4 mt-n1-9 mb-2">
            ...
            height:'620px',
              ...
              <p>The SQ-Panel can notify you when expected and unexpected events occur. For example, if a window is
           left open or cooking is taking place in a room, you will receive a notification.
