          ...
          <div className="row">
            ...
            <div className="col-lg-10 mt-n1-9" style={{ textAlign: 'justify' }}>
              <p className="mt-5">
                {state === 'en' && (
                  <>
                    Would you like to make your home smarter, safer and
                    healthier?
                  </>
                )}
                {state === 'de' && (
                ...
                {state === 'de' && (
                  <>
                    ...
                    Zuhause überwachen, verbessern und gesunde Luft atmen?
                  </>
                )}
                <br />
                {state === 'en' && (
                  <>
                    Would you like to stay in touch with your loved ones and
                    know that they are safe and well ventilated even from a
                    distance?
                  </>
                )}
                {state === 'de' && (
              ...
              <p className="mt-1">
                {state === 'en' && (
                  <>
                    The Carenuity SQ-Panel is a 2.6-inch touchscreen with
                    built-in sensors. It displays the relevant sensor values of
                    the room air. These are temperature, humidity, air pressure,
                    carbon dioxide (C02) and airborne organic compounds (TVOC).
                    It also detects the presence of people in the room, which it
                    can detect and monitor up to 6m.
                  </>
                )}
                {state === 'de' && (
                  <>
                    ...
                    der Luft (TVOC). Es erkennt auch die Anwesenheit von
                    Personen im Raum, den er bis zu 6m erfassen und überwachen
                    kann.
                  </>
                )}
              </p>
              <p className="mt-1">
                {state === 'en' && (
                  <>
                    The Carenuity smartphone app allows you to access the
                    SQ-Panel while on the move and lets you monitor the SQ-Panel
                    from anywhere and, for example, activate the alarm when you
                    are away.
                  </>
                )}
                {state === 'de' && (
                  <>
                    Die Carenuity Smartphone App erlaubt Ihnen den Zugriff auf
                    das SQ-Panel von unterwegs und lässt Sie das SQ-Panel von
                    überall aus monitoren und beispielsweise den Alarm bei
              ...
              <div className="col-10 ms-4 wow fadeIn" data-wow-delay="200ms">
                <div className="d-flex align-items-center">
                  ...
                  <span className="ms-3 text-dark fw-bold">
                    {state === 'en' && (
                      <>
                        View the sensor values of your Carenuity SQ panel in
                        real time, from anywhere and at any time.
                      </>
                    )}
                    {state === 'de' && (
                      <>
                ...
                <div className="d-flex align-items-center">
                  ...
                  <span className="ms-3 text-dark fw-bold">
                    {state === 'en' && (
                      <>
                        Monitor the air quality over time at your loved
                        ones&apos; location or in your home and communicate with
                        your loved ones if you notice that an expected airing or
                        other daily routine has not or not yet taken place.
                      </>
                    )}
                    {state === 'de' && (
                      <>
                        Überwachen Sie den zeitlichen Verlauf der Luftqualität
                        am Standort Ihrer Lieben oder in Ihrem Zuhause und
                        kommunizieren Sie mit ihren Lieben, wenn Sie bemerken,
                        dass ein erwartetes Lüften oder eine andere
                  ...
                  <span className="ms-3 text-dark fw-bold">
                    ...
                    {state === 'de' && (
                      <>
                        ...
                        können hilfreich sein. Erhalten Sie individuelle
                        Einblicke und Tipps zur Verbesserung der Luftqualität
                        und Sicherheit in Ihrem Zuhause.
                      </>
                    )}
                  </span>
                </div>
              ...
              <p className="mt-3">
                {state === 'en' && (
                  <>
                    ...
                    have it mounted in the wall, in which case it is wireless,
                    or you can simply place it on a table, chest of drawers or
                    shelf. You can adjust the display settings such as
                    brightness and color to suit your preferences.
                  </>
                )}
                {state === 'de' && (
                  <>
                    ...
                    ist es kabellos, oder Sie stellen es einfach auf einen
                    Tisch, eine Kommode oder ins Regal. Sie können die
              ...
              <p className="mt-1">
                {state === 'en' && (
                  <>
                    ...
                    a good and totally discreet way to show your loved ones you
                    care, and for yourself too. It helps to create a
                    comfortable, healthy and safe environment in your home.It
                    also keeps you connected to your loved ones and allows you
                    to care for and support them even when you are not
                    physically there.
                  </>
                )}
                {state === 'de' && (
                  <>
                    ...
                    gute und absolut diskrete Art und Weise, ihren Lieben Ihre
                    Fürsorge zu zeigen, und auch für Sie selbst. Es hilft eine
                    komfortable, gesunde und sichere Umgebung in Ihrem Heim zu
                    schaffen. Es hält Sie auch mit Ihren Lieben in einer
                    Verbindung und ermöglicht Ihnen, sie zu betreuen und zu
                    unterstützen, auch wenn Sie sich nicht physisch vor Ort
                    befinden.
                  </>
                )}
              </p>
              <p className="mt-1">
                ...
                {state === 'de' && (
                  <>
                    ...
                    Unterstützen Sie uns auf Kickstarter und bestellen Sie es
                    noch heute.
                  </>
                )}
              </p>
                    ...
                    <p>
                      {state === 'en' && (
                        <>
                          ...
                          circulation. If the VOC content rises, it&apos;s time
                          to ventilate.
                        </>
                      )}
                      {state === 'de' && (
                        <>
                          ...
                          Luftqualität in der Küche überwachen. Das SQ-Panel
                          zeigt Ihnen die aktuellen Werte an und hilft Ihnen
                          dabei, die Luftzirkulation zu optimieren. Wenn der
                          VOC-Gehalt steigt, wird es Zeit zu lüften.
                        </>
                      )}
                    </p>
                  </div>
                    ...
                    <p>
                      {state === 'en' && (
                        <>
                          ...
                          absence. Users can now switch off the light or turn
                          down the heating to save energy until guests return.
                          The device provides information and ensures comfort.
                        </>
                      )}
                      {state === 'de' && (
                        <>
                          ...
                          bis Gäste wieder kommen. Das Gerät informiert und
                          sorgt für Komfort.
                        </>
                      )}
                    </p>
