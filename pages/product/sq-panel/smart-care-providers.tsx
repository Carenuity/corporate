                  ...
                  />
                        ...
                        <div className="col-md-8 mb-4">
                         <p>
                                    {state === 'en' && (
                          <>
                            <strong>Smart Care Providers</strong> are healthcare professionals and organizations that 
                            leverage technology to enhance patient care, improve operational efficiency, and promote 
                            wellness. These providers often focus on creating environments that support the health and 
                            comfort of individuals, especially in settings like hospitals, nursing homes, rehabilitation
                             centers, and home care services. Their goal is to ensure optimal conditions for patients' 
                             recovery and well-being, as well as to prevent health risks associated with poor environmental
                              conditions.
                        ...
                        {state === 'de' && (
                          <>
                          <strong>Smart Care Providers</strong> sind medizinische Fachkräfte und Organisationen, die 
                          Technologie nutzen, um die Patientenversorgung zu verbessern, die betriebliche Effizienz zu 
                          verbessern und das Wohlbefinden zu fördern. Diese Anbieter konzentrieren sich häufig auf die 
                          Schaffung von Umgebungen, die die Gesundheit und das Wohlbefinden des Einzelnen unterstützen, 
                          insbesondere in Einrichtungen wie Krankenhäusern, Pflegeheimen, Rehabilitationszentren und 
                          häuslichen Pflegediensten. Ihr Ziel ist es, optimale Bedingungen für die Genesung und das 
                          Wohlbefinden der Patienten zu gewährleisten und Gesundheitsrisiken im Zusammenhang mit schlechten 
                          Umweltbedingungen vorzubeugen.
                         ...
                         <p>
                          ...
                          <>
                            ...
                            The <strong>SQ panel</strong> is an essential tool for Smart Care Providers, offering real-time monitoring of 
                          indoor air quality, temperature, humidity, pressure, carbon dioxide (CO₂), total volatile organic 
                          compounds (TVOC), and presence. In healthcare settings, these factors are critical for preventing 
                          issues such as respiratory distress, infections, and discomfort. By continuously displaying these 
                          key metrics, the panel allows care providers to maintain optimal conditions for patients, quickly 
                          adjust the environment as needed, and track changes over time. This proactive approach not only 
                          supports patient health and comfort but also ensures compliance with health and safety regulations, 
                        ...
                        {state === 'de' && (
                          ...
                          Das <strong>SQ-Panel</strong> ist ein unverzichtbares Tool für Smart-Care-Anbieter und bietet Echtzeitüberwachung der 
                        Raumluftqualität, der Temperatur, der Luftfeuchtigkeit, des Drucks, des Kohlendioxids (CO₂), 
                        der gesamten flüchtigen organischen Verbindungen (TVOC) und der Anwesenheit. Im Gesundheitswesen 
                        sind diese Faktoren entscheidend für die Vorbeugung von Problemen wie Atemnot, Infektionen und 
                        Beschwerden. Durch die kontinuierliche Anzeige dieser Schlüsselkennzahlen ermöglicht das Panel 
                        Pflegedienstleistern, optimale Bedingungen für Patienten aufrechtzuerhalten, die Umgebung bei 
                        Bedarf schnell anzupassen und Veränderungen im Laufe der Zeit zu verfolgen. Dieser proaktive 
                        Ansatz unterstützt nicht nur die Gesundheit und das Wohlbefinden der Patienten, sondern stellt 
                        auch die Einhaltung von Gesundheits- und Sicherheitsvorschriften sicher und verbessert so die 
