            ...
            >
              ...
              <p style={{ padding: '10px' }}>
                ...
                required.
                  ...
                  <h4>Barometer</h4>
                  <p>
                      Measures atmospheric pressure. It can be equipped with a display to show 
                      pressure readings or a buzzer to signal significant changes, which may 
                      indicate weather shifts.<br/>
                       <a href="https://www.instagram.com/p/DMu1xu1NIEp/" target='blank'>
                      <u>See how to assemble</u><br/>
                    </a>
                    <a href="https://www.instagram.com/p/DMu5_BgtxYJ/" target='blank'>
                  ...
                  <hr className='mb-4'/>
                    <h4>Hygrometer</h4>
                    <p> Monitors air humidity. It may use a display to show relative humidity 
                      or a buzzer to alert when humidity levels fall outside a desired range.<br/>
                      <a href="https://www.instagram.com/p/DMxBFH7tDSY/" target='blank'>
                      <u>See how to assemble</u><br/>
                    </a>
                    </p>
                  {/* Hygrometer-1 */}
                  ...
                  <SolutionWidget solutionId="KiKMCrAtAioE0f3vcQ3Q" />
                   ...
                   <hr className='mb-4'/>
                    <h4>IR Radiometer</h4>
                    <p>
                      Detects thermal radiation without contact. It can use a display to show surface temperatures 
                      or a buzzer to indicate abnormal thermal readings.<br/>
                      <a href="https://www.instagram.com/p/DMxWqowNWAo/" target='blank'>
                  ...
                  <SolutionWidget solutionId="KzjsdjS3rA1J5ABAn9Uu" />
                   ...
                   <hr className='mb-4'/>
                    <h4>Luxmeter</h4>
                    <p>
                       Measures light intensity. It may have a display showing lux values or a buzzer that 
                       activates when light levels are too high or too low.<br/>
                       <a href="https://www.instagram.com/p/DMxcpzuthU5/" target='blank'>
                      <u>See how to assemble</u>
                    </a>
                    </p>
                  ...
                  <SolutionWidget solutionId="74eP4Syrjw85D0UWmqqi" />
                   ...
                   <hr className='mb-4'/>
                    ...
                    <p>
                      Measures temperature. It can feature a display for real-time temperature readings 
                      or a buzzer to notify when temperatures exceed or drop below set thresholds.<br/>
                      <a href="https://www.instagram.com/p/DMxD5ILtbvc/" target='blank'>
                      <u>See how to assemble</u><br/>
                    </a>
                    <a href="https://www.instagram.com/solutions.carenuity/reel/DNAkYVetFUD/" target='blank'>
                      <u>How to install</u>
                    </a>
                    </p>
                  ...
                  <SolutionWidget solutionId="T8iq4WKgvGuCrREcLNzC" />
                   ...
                   <hr className='mb-4'/>
                    ...
                    <p>
                      Senses movement. It may show motion status on a display or use a buzzer to audibly alert 
                      when movement is detected.<br/>
                      <a href="https://www.instagram.com/p/DM-BLZttwyd/" target='blank'>
                      <u>See how to assemble</u>
                    </a>
                    </p>
                  ...
                  <SolutionWidget solutionId="UvGo54vaf9rNgSVCuuDp" />
                   ...
                   <hr className='mb-4'/>
                    ...
                    <p>
                      Detects user presence through interaction. It can confirm activation via a display or 
                      provide feedback through a buzzer when pressed.<br/>
                      <a href="https://www.instagram.com/p/DNAb3TGN9UA/" target='blank'>
                      <u>See how to assemble</u>
                    </a>
                    </p>
                  {/* Presence Detector */}
