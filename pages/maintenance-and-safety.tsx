      ...
      <section className="overflow-hidden py-3">
        <div className="container position-relative z-index-3">
          <div>
            ...
            <p>
              Proper maintenance and safe installation ensure accurate sensor
              readings, long device life, and reliable alerts.
            </p>

            <h4>1. Cleaning</h4>
            <ul>
              <li>
                Use a <strong>soft, dry cloth</strong> to wipe the surface of
                the SQ-Panel.
              </li>
              <li>
              ...
              <li>
                Do <strong>not open the device</strong>; internal components are
                sensitive.
              </li>
              <li>
                Recommended cleaning frequency: <strong>once a month</strong> or
            ...
            <ul>
              ...
              <li>
                Disconnect the device during <strong>lightning storms</strong>{' '}
            ...
            <ul>
              <li>
                <strong>Height:</strong> Mount approximately{' '}
                <strong>1.2–1.5 m</strong> above floor level for accurate
                temperature, humidity, and CO₂ measurements.
              </li>
              <li>
                <strong>Distance from walls:</strong> Leave at least{' '}
                <strong>10 cm clearance</strong> around the device.
              </li>
              <li>
                <strong>Avoid drafts:</strong> Do not place near open windows,
                fans, or air conditioning vents.
              </li>
              <li>
                <strong>Room coverage:</strong> Place centrally in the room to
                get representative readings of the overall environment.
              </li>
              <li>
                <strong>Multi-room setups:</strong> Use additional SQ-Panels if
            ...
            <ul>
              <li>
                ...
                <strong>water, high humidity, or extreme temperatures</strong>.
              </li>
              <li>
                Keep the device <strong>away from flammable materials</strong>.
              </li>
              <li>
                Always follow the{' '}
                <strong>app prompts and firmware updates</strong> to maintain
                safe operation.
              </li>
            </ul>
          </div>
