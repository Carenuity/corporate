          ...
          <div className="row">
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  This guide will walk you through its features, setup, and
                  integration with an ESP32 microcontroller, providing a solid
                  foundation for AI dev
                </p>
              </div>
            </div>
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>
                      Introducing the SQ Panel: Your Smart Home&apos;s New Best
                      Friend
                    </u>
                  </h5>
                </a>
                ...
                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  ...
                  Chipglobe is excited to announce our latest innovation: the SQ
                  Panel.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>Creating Your First YAML File in Home Assistant</u>
                  </h5>
                </a>
            ...
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>
                      Utilizing Google Sheets in Home Assistant: A Comprehensive
                      Guide
                    </u>
                  </h5>
                </a>
                ...
                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  Greetings, tech enthusiasts! Today, we&apos;re delving into
                  the intricacies of incorporating Google Sheets into Home
                  Assistant, a powerful...
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>Sensor Data Optimization for Enhanced AI Performance</u>
                  </h5>
                </a>

                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  Hello tech enthusiasts, In the realm of artificial
                  intelligence, sensor data plays a crucial role in shaping the
                  accuracy and...
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>
                      Revolutionizing Home Living: The Synergy of Home
                ...
                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  In the age of rapid technological advancement, our homes are
                  becoming smarter and more intuitive than ever before. At the
                  heart of this...
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>
                      Beginner&apos;s Guide: Automating Lights with HLK-LD2410
                      and Home Assistant
                    </u>
                  </h5>
                </a>
                ...
                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  Hello Tech Enthusiast! Welcome to today&apos;s tutorial where
                  we embark on a journey into the realm of Home Automations
            ...
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>
                      A Detecting the Future: Exploring the Exciting
                ...
                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  You might be wondering; where do I apply Object Detection?
                  Well hold on to your hats because we&apos;re about to explore
                  some seriously cool...
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mb-4">
              ...
              >
                ...
                >
                  <h5 style={{ padding: '10px' }}>
                    <u>Welcome to ChipGlobe&apos;s Embedded AI Journal!</u>
                  </h5>
                </a>

                <p style={{ paddingLeft: '10px', paddingRight: '10px' }}>
                  Greetings, tech enthusiasts, innovators, and fellow explorers!
                  We&apos;re Melina and Cynthia, Embedded AI Engineers at
                  ChipGlobe, and we&apos;re...
                </p>
              </div>
            </div>
