  ...
  return (
    <>
      ...
      <div className="container">
          ...
          <p >
           Carenuity™ is a registered European brand focused on advanced sensor systems, embedded development and 
           smart integration. The brand is visible across multiple online platforms relevant to developers, makers, 
           integrators and technology stakeholders. 
          </p>
          ...
          <div>
              ...
              <p >
                ...
                <ul>
                  ...
                  <li>Instagram (visual demos, product reels, and sensor deployments)</li>
                </ul>
                It also appears in blog articles and newsletters by developers and maker communities.
              </p>
          </div>
          <div>
            <h4>
            ...
            <p >
              The Carenuity™ Solution Builder is a web-based configuration and simulation tool that uses the Carenuity™ 
              brand design, logo and product naming. It is referenced in:
              <ul>
