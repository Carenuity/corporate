...
const Privacy = () => {
  ...
  <p>
    Diese Datenschutzerklärung informiert Sie darüber, wie die Chipglobe GmbH („wir“, „uns“, „unser“) 
    Ihre personenbezogenen Daten verarbeitet, wenn Sie unsere Website besuchen oder unsere mobile App verwenden. 
  ...
  <ul>
    <li><strong>Von Ihnen bereitgestellte Daten:</strong> z. B. beim Ausfüllen von Formularen, bei der Registrierung, 
    bei Supportanfragen oder bei der Nutzung der App.</li>
    <li><strong>Automatisch erfasste Daten:</strong> Technische Informationen wie IP-Adresse, Gerätetyp, Betriebssystem,
     Browser- bzw. App-Version, Zugriffszeit oder Absturzdaten.</li>
  </ul>

  <h6>Zweck der Datenverarbeitung</h6>
  <ul>
    <li>Gewährleistung des technischen Betriebs unserer Website und App</li>
    <li>Verbesserung unserer Dienste und Benutzerfreundlichkeit</li>
    <li>Kommunikation mit Ihnen (z. B. Support, Vertragsabwicklung, Anfragen)</li>
  ...
  <p>
    Im Falle datenschutzrechtlicher Verstöße steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. Eine Übersicht finden Sie hier:<br/>
    <a href="https://www.bfdi.bund.de/DE/Infothek/Anschriften_Links/anschriften_links-node.html" target="_blank">
  ...
  <p>
    Sie haben das Recht, Daten, die Sie uns bereitgestellt haben, in einem maschinenlesbaren Format zu erhalten oder
     an Dritte übertragen zu lassen.
  </p>

  <h6>Verschlüsselung und Sicherheit</h6>
  <p>
    Unsere Website und App verwenden TLS 1.3-Verschlüsselung und moderne Sicherheitsmechanismen. Wir führen regelmäßige 
    Sicherheitsüberprüfungen durch, um Daten vor unbefugtem Zugriff oder Verlust zu schützen.
  </p>
  ...
  <p>
    Wir verwenden Cookies und ähnliche Technologien (z. B. Local Storage), um Sitzungsdaten, Einstellungen und Anmeldungen zu 
    speichern. Beim ersten Besuch oder Start der App können Sie festlegen, welche Kategorien (notwendig, funktional, Analyse,
     Marketing) Sie zulassen möchten.
  </p>
  ...
  <p>Diese Daten dienen ausschließlich der technischen Bereitstellung, Systemsicherheit und Fehleranalyse.</p>

  <h6>Kontaktformulare und Supportanfragen</h6>
  <p>
    Wenn Sie uns per Formular, E-Mail oder App kontaktieren, verarbeiten wir Ihre Angaben zur Bearbeitung Ihrer Anfrage. 
    Rechtsgrundlage: Ihre Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) oder bei vertraglichem Bezug Art. 6 Abs. 1 lit. b DSGVO.
  </p>
  ...
  <h6>Google Analytics 4</h6>
  <p>
    Unsere Website nutzt Google Analytics 4 mit IP-Anonymisierung zur Analyse und Verbesserung der Nutzung. Datenübertragung an
     Google LLC (USA) erfolgt im Rahmen des EU-US Data Privacy Framework.<br/>
    Opt-out: <a href="https://tools.google.com/dlpage/gaoptout?hl=de" target="_blank">https://tools.google.com/dlpage/gaoptout?hl=de</a>
  </p>

  <h6>Firebase Analytics (App)</h6>
  <p>
    Unsere App verwendet Firebase Analytics (Google LLC) zur anonymisierten Nutzungsanalyse, Fehlerdiagnose und Leistungsoptimierung. 
    Personenbezogene Identifizierung erfolgt nicht.
  </p>
  ...
  <h6>YouTube</h6>
  <p>
    Unsere Website und App können Inhalte von YouTube einbetten. Anbieter: YouTube LLC, 901 Cherry Ave., San Bruno, CA 94066, 
    USA. Eine Datenübertragung an YouTube erfolgt erst nach Ihrer Zustimmung (Art. 6 Abs. 1 lit. a DSGVO).
  </p>

  <h6>Google Maps / Apple Maps</h6>
  <p>
    Für Standortfunktionen unserer App nutzen wir Kartendienste wie Google Maps oder Apple Maps. IP-Adresse und Standortdaten 
    werden nur bei erteilter Zustimmung übertragen.
  </p>

  <h6>Push-Benachrichtigungen (App)</h6>
  <p>
    Wenn Sie Push-Nachrichten aktivieren, speichern wir ein anonymes Geräte-Token, um Ihnen relevante Mitteilungen zu senden. 
    Sie können Benachrichtigungen jederzeit in den App-Einstellungen deaktivieren.
  </p>
  ...
  <p>
    ...
    Aufbewahrungsfristen bestehen. Nach Wegfall des Zwecks oder Ablauf der Frist werden die Daten gelöscht oder anonymisiert.
  </p>

  <h4>8. Änderungen dieser Datenschutzerklärung</h4>
  <p>
    Diese Datenschutzerklärung kann bei rechtlichen Änderungen oder technischen Anpassungen aktualisiert werden. 
    Über wesentliche Änderungen informieren wir Sie auf unserer Website oder innerhalb der App.
  </p>
