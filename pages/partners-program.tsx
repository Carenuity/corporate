            ...
            <div className="row" >
              ...
              <div className="col-md-4 mb-12" style={{ textAlign: 'center' }}>
                ...
                ></input>
                 ...
                 <p>We use your personal data to provide you with the best possible user experience 
                  on this website, to manage access to your account, and for other purposes described 
                  in our privacy policy .</p>
                  <input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"></input>
                  <label className='mb-4'> I have read and agree to  the terms and conditions . *</label><br></br>
