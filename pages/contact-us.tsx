...
const Page = () => {
  ...
  return (
    <>
            ...
            <div className='row'>
                 ...
                 <div className="col-md-4 mb-4">
                  ...
                  >
                    ...
                    <Phone className="text-blue-500 mb-4" size={40} /><br/>
                    <a href="tel:+1234567890" className="hover:underline">
                    <h6 style={{ color:"#ffffff",}}>
                      (+49) 89-1222469-40</h6> 
                      
                    </a>
                    <p style={{ fontSize:"12px",}} >Reach out to our team directly by phone during our business hours</p>
                  </div>
                 ...
                 <div className="col-md-4 mb-4">
                  ...
                  >
                    <div style={{ padding: '30px',
                      ...
                      <div className="flex items-center space-x-2">
        <Mail className="text-green-500 mb-4" size={40} /><br/>
        <a href="mailto:info@example.com" className="hover:underline">
          <h6 style={{ color:"#ffffff",}}>
          info@carenuity.com</h6>
          
        </a>
        <p style={{ fontSize:"12px",}}>Email our team — we&apos;re happy to assist you with any inquiries or support needs.</p>
      </div>
      ...
      <div id="popup-message" className="mt-3 font-semibold" style={{ display: 'none' }}></div>
...
export default Page;
>>>>>>> cd69c3b7c7d4022480dde0db1ca0188ebe716faf
