    ...
    <>
      ...
      <section className="container">
        ...
        >
          <div className=" row ">
            <div className="col-md-8 ">
              <h5>
              {state === 'en' && <>The SQ-Panel shows the Air Quality level you breathe</>}
              {state === 'de' && <>Das SQ-Panel zeigt die Luftqualitätsstufe an, die Sie einatmen</>}
                </h5>
              <p>
              {state === 'en' && <>
                ...
                {state === 'de' && <>
                  Das SQ-Panel verfügt über eingebaute Sensoren zur Messung der Luftqualität,
                Temperatur, Feuchtigkeit, Druck, Kohlendioxid, TVOC und
                Anwesenheit. Das SQ-Panel ist über den Carenuity Border Router mit der Carenuity-Cloud verbunden.
                Carenuity Border Router, der als Gateway zwischen Ihrem
                Heimnetzwerk und dem Internet fungiert. So können Sie die Sensorwerte überwachen
                Sensorwerte zu überwachen und deren Schwellenwerte von überall aus festzulegen,
                mit der Carenuity Home App auf Ihrem Smartphone.</>}
              </p>
              <p></p>
            </div>
          ...
          <div className="col-md-6 mb-2">
            ...
            >
              ...
              >
                ...
                {state === 'de' && <>
                  Ich unterstütze das Carenuity SQ-Panel aufgrund seiner beeindruckenden Funktionen.
                Die Überwachung der Luftqualität, Echtzeitwarnungen und der Fernzugriff
                über die App sind für die Gesunderhaltung meiner Familie unerlässlich. Die
                historischen Daten und Einblicke helfen mir, unser Wohnumfeld
                Umgebung sicher und komfortabel ist. Es ist eine kluge Wahl
                für jeden, der Wert auf Wellness zu Hause legt.</>}
          ...
          <div className="col-md-6 ">
            ...
            >
              ...
              >
                ...
                safety.</>}
                {state === 'de' && <>Ich unterstütze das Carenuity SQ-Panel wegen seiner erstklassigen Eigenschaften. Das
                umfassende Überwachung der Luftqualität, Echtzeit-Warnungen und
                Fernzugriff über die App helfen mir, ein gesundes Zuhause für meine
                Familie. Die historischen Daten und Einblicke sind ein Bonus und machen es
                eine kluge Investition für jeden, der Wert auf Komfort und Sicherheit in seinem
                Sicherheit.</>}
        ...
        >
          <div className=" row ">
            ...
            <div className="col-md-8 ">
              ...
              <h5>
              {state === 'en' && <>Why choose SQ-Panel</>} </h5>
              ...
              <p>
                ...
                {state === 'de' && <>
                  Das SQ-Panel wird mit einer Smartphone-App geliefert, mit der Sie die
                SQ-Panel-Sensorwerte von überall aus überwachen und sich bei
                sich die Werte ändern. Außerdem verfügt es über einen Sensor, der die menschliche
                Anwesenheit im Raum erkennt. Sobald Sie Ihren Alarm aktivieren, werden Sie
                Dies sind nur wenige Gründe, warum das SQ-Panel so nützlich ist.
                Gründe, warum SQ-Panel vorteilhaft ist. Klicken Sie auf Mehr erfahren und
                und erfahren Sie mehr über die 11 Anwendungsfälle, die Sie mit dem SQ-Panel erhalten</>}
              ...
              <p>
                ...
                {state === 'de' && <>
                  Wir bieten rund um die Uhr lebenswichtige, umweltbezogene Erkennung und Betreuung, damit
                  Sie sehen können, was niemand sonst sehen wird.</>}
              ...
              <p className=" ">
                {!isMobile && (
                  ...
                  >
                    ...
                    {state === 'en' && <>Learn More</>} {state === 'de' && <> Mehr erfahren</>} </span>
                  </Link>
                )}
                ...
                {isMobile && (
                  ...
                  >
                    <span className="small">
                    {state === 'en' && <>Learn More</>} {state === 'de' && <> Mehr erfahren</>}{' '}
        ...
        <div className="row mb-1">
          ...
          {state === 'de' && <>Einige Bilder zeigen die Blitzhalterung und den Tischständer SQ-Panel</>}
          ...
          <p>
            ...
            distance.</>}
            {state === 'de' && <>
            Holen Sie sich eine und verbessern Sie die Luftqualität, den Komfort in Ihrem Haus und
            atmen Sie gesunde Luft. Es wird Sie auch mit Ihren Lieben verbinden
            und wissen, dass sie sicher und gut belüftet sind, auch aus der
            Entfernung.</>}
        ...
        <div className=" mb-2">
          <div className=" mb-2">
            ...
            {state === 'de' && <>
              Matter ermöglicht Ihnen die Integration Ihres Sensorgeräts in bis zu fünf
              der beliebtesten Plattformen auf einmal, wie Amazon&apos;s
              Alexa, Apple&apos;s Home, Google Home, Samsung&apos;s SmartThings,
              oder Home Assistant (HA).</>}
