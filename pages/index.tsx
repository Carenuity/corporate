  ...
  return (
    <>
        ...
        <section
          ...
          style={{ backgroundImage: 'url(img/content/video-bg-img.jpg)' }}
          data-jarallax
          data-speed='0.8'
            ...
            <div className='row align-items-end g-5 g-lg-0 position-relative z-index-9 mt-n1-9'>
              ...
              >
                <div className='text-start text-lg-end'>
                  ...
                  <p className='mb-0'>
                    We work to understand your issues and are driven to ask
                    better questions.
                  </p>
                </div>
              </div>
                      ...
                      <div>
                        <blockquote>
                          ...
                          <p className='mb-0 display-sm-27'>
                            ...
                            learn more about it. We were treated like royalty.
                            IT solution should be nominated for service of the
                            year. I made back the purchase price in just 48
                            hours!
                          </p>
                        </blockquote>
                        <div className='d-flex align-items-center'>
                    ...
                    <div className='col-lg-6 mt-2-9'>
                      <div>
                        <blockquote>
                          <div className='icon'>&quot;</div>
                          <p className='mb-0 display-sm-27'>
                            IT solution is the most valuable business resource
                            we have EVER purchased. I am completely blown away.
                            I love your system. It&apos;s exactly what I&apos;ve
                            been looking for. I love business. It really saves
                            me time and effort.
                          </p>
                        </blockquote>
                        <div className='d-flex align-items-center'>
